...
class GetTestCases(unittest.TestCase):
    def test_get_database_tables(self):
        r = requests.get(
                'http://192.168.1.201:9090/get_database_table'
            )
    ...
    def test_get_payments(self):
        r = requests.get(
                'http://192.168.1.201:9090/get_database_table/payments'
            )
        self.assertNotEqual(r.json(), "Database Inaccessible")
        self.assertEqual(r.status_code, 200)
    ...
    def test_get_customers(self):
        r = requests.get(
                'http://192.168.1.201:9090/get_database_table/customers'
            )
        self.assertNotEqual(r.json(), "Database Inaccessible")
        self.assertEqual(r.status_code, 200)
    ...
    def test_get_offices(self):
        r = requests.get(
                'http://192.168.1.201:9090/get_database_table/offices'
            )
        self.assertNotEqual(r.json(), "Database Inaccessible")
        self.assertEqual(r.status_code, 200)
